...
| 更新日 | 2026-06-30 |
| 状態 | 正式 |
| 関連文書 | [システムアーキテクチャ](01_システムアーキテクチャ.md), [API設計](../03_api/01_API設計.md), [DB設計](../04_data/01_DB設計.md), [画面設計](../02_ui/02_画面設計.md) |

## AI Summary

Admin画面から教材（Lesson）のdraft/publishedライフサイクルを管理するコンテキスト。LLM生成物は必ずdraftで保存し自動公開しない。削除は確認ダイアログ必須、修正案の自動反映も禁止。
...
<img alt="img" src="../00_images/02_component.png" width="400">
